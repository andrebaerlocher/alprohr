...
>
	...
	<p style:font-weight="bold" style:grid-row="1" style:align-self="end">{currentEvent.title}</p>
	<p style:grid-row="2" style:align-self="start">{currentEvent.dateString}</p>
	<p></p>
</a>

...
{#if visible}
	<button transition:blur={{ duration: 300 }} onclick={() => (visible = false)}>
		<div class="modal">
			...
			<h3>WIX</h3>
			<p>
				Anbieter ist die Wix.com Ltd., 40 Namal Tel Aviv St., Tel Aviv 6350671, Israel (nachfolgend
				&bdquo;WIX&ldquo;).
			</p>
			<p>
				WIX ist ein Tool zum Erstellen und zum Hosten von Webseiten. Wenn Sie unsere Website
				besuchen, werden mit Hilfe von WIX das Nutzerverhalten, die Besucherquellen, die Region der
				Websitebesucher und die Besucherzahlen analysiert. WIX speichert Cookies auf Ihrem Browser,
				die f&uuml;r die Darstellung der Website und zur Gew&auml;hrleistung der Sicherheit
				erforderlich sind (notwendige Cookies).
			</p>
			<p>
				Die Daten, die &uuml;ber WIX erfasst werden, k&ouml;nnen auf verschiedenen Servern weltweit
				gespeichert werden. Die Server von WIX stehen u.&nbsp;a. in den USA.
			</p>
			<p>
				Details entnehmen Sie der Datenschutzerkl&auml;rung von WIX: <a
					href="https://de.wix.com/about/privacy"
					target="_blank"
					rel="noopener noreferrer">https://de.wix.com/about/privacy</a
				>.
			</p>
			<p>
				Die Daten&uuml;bertragung in die USA und sonstige Drittstaaten wird laut WIX auf die
				...
				gest&uuml;tzt. Details finden Sie hier: <a
					href="https://de.wix.com/about/privacy-dpa-users"
					target="_blank"
					rel="noopener noreferrer">https://de.wix.com/about/privacy-dpa-users</a
				>.
			</p>
			<p>
			...
			<p>
				...
				Datenschutzstandards bei Datenverarbeitungen in den USA gew&auml;hrleisten soll. Jedes nach
				...
				Weitere Informationen hierzu erhalten Sie vom Anbieter unter folgendem Link: <a
					href="https://www.dataprivacyframework.gov/participant/5626"
					target="_blank"
					rel="noopener noreferrer">https://www.dataprivacyframework.gov/participant/5626</a
				>.
			</p>
			...
			<p>
				Nicole und Andre Van Kesteren<br />
				Alte Landstrasse 83<br />
				9445 Rebstein<br />
				Schweiz
			</p>

			<p>
				Telefon: 079 656 05 81<br />
				E-Mail: a.vankesteren@gmx.ch
			</p>
			<p>
			...
			<p>
				...
				Dienstes ist die Meta Platforms Ireland Limited, Merrion Road, Dublin 4, D04 X2K5, Irland.
				Die erfassten Daten werden nach Aussage von Facebook jedoch auch in die USA und in andere
				Drittl&auml;nder &uuml;bertragen.
			</p>
			<p>
				Eine &Uuml;bersicht &uuml;ber die Facebook Social-Media-Elemente finden Sie hier: <a
			...
			<p>
				...
				Endger&auml;t und dem Facebook-Server hergestellt. Facebook erh&auml;lt dadurch die
				...
				hierzu finden Sie in der Datenschutzerkl&auml;rung von Facebook unter: <a
			...
			<p>
				Die Nutzung dieses Dienstes erfolgt auf Grundlage Ihrer Einwilligung nach Art. 6 Abs. 1 lit.
				a DSGVO und &sect; 25 Abs. 1 TDDDG. Die Einwilligung ist jederzeit widerrufbar.
			</p>
			<p>
				...
				Limited, 4 Grand Canal Square, Grand Canal Harbour, Dublin 2, Irland gemeinsam f&uuml;r
				...
				Weitergabe an Facebook. Die nach der Weiterleitung erfolgende Verarbeitung durch Facebook
				ist nicht Teil der gemeinsamen Verantwortung. Die uns gemeinsam obliegenden Verpflichtungen
				wurden in einer Vereinbarung &uuml;ber gemeinsame Verarbeitung festgehalten. Den Wortlaut
				der Vereinbarung finden Sie unter: <a
					href="https://www.facebook.com/legal/controller_addendum"
					target="_blank"
					rel="noopener noreferrer">https://www.facebook.com/legal/controller_addendum</a
				>. Laut dieser Vereinbarung sind wir f&uuml;r die Erteilung der Datenschutzinformationen
				beim Einsatz des Facebook-Tools und f&uuml;r die datenschutzrechtlich sichere
				Implementierung des Tools auf unserer Website verantwortlich. F&uuml;r die Datensicherheit
				der Facebook-Produkte ist Facebook verantwortlich. Betroffenenrechte (z.&nbsp;B.
				Auskunftsersuchen) hinsichtlich der bei Facebook verarbeiteten Daten k&ouml;nnen Sie direkt
				bei Facebook geltend machen. Wenn Sie die Betroffenenrechte bei uns geltend machen, sind wir
			...
			<p>
				...
				werden angeboten durch die Meta Platforms Ireland Limited, Merrion Road, Dublin 4, D04 X2K5,
				Irland.
			</p>
			<p>
				Wenn das Social-Media-Element aktiv ist, wird eine direkte Verbindung zwischen Ihrem
			...
			<p>
				...
				gemeinsam f&uuml;r diese Datenverarbeitung verantwortlich (Art. 26 DSGVO). Die gemeinsame
				Verantwortlichkeit beschr&auml;nkt sich dabei ausschlie&szlig;lich auf die Erfassung der
				Daten und deren Weitergabe an Facebook bzw. Instagram. Die nach der Weiterleitung erfolgende
				Verarbeitung durch Facebook bzw. Instagram ist nicht Teil der gemeinsamen Verantwortung. Die
				uns gemeinsam obliegenden Verpflichtungen wurden in einer Vereinbarung &uuml;ber gemeinsame
				Verarbeitung festgehalten. Den Wortlaut der Vereinbarung finden Sie unter: <a
					href="https://www.facebook.com/legal/controller_addendum"
					target="_blank"
					rel="noopener noreferrer">https://www.facebook.com/legal/controller_addendum</a
				>. Laut dieser Vereinbarung sind wir f&uuml;r die Erteilung der Datenschutzinformationen
				beim Einsatz des Facebook- bzw. Instagram-Tools und f&uuml;r die datenschutzrechtlich
				sichere Implementierung des Tools auf unserer Website verantwortlich. F&uuml;r die
				Datensicherheit der Facebook bzw. Instagram-Produkte ist Facebook verantwortlich.
				Betroffenenrechte (z.&nbsp;B. Auskunftsersuchen) hinsichtlich der bei Facebook bzw.
				Instagram verarbeiteten Daten k&ouml;nnen Sie direkt bei Facebook geltend machen. Wenn Sie
			...
			<p>
				...
				diese Website aufgerufen wurde. Die Nutzung von Google Fonts erfolgt auf Grundlage von Art.
				6 Abs. 1 lit. f DSGVO. Der Websitebetreiber hat ein berechtigtes Interesse an der
